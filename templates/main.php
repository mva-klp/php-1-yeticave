	...
	<ul class="lots__list">
		...
		<li class="lots__item lot">
			<div class="lot__image">
				<img src="<?= $good['img_url']; ?>" width="350" height="260" alt="">
			</div>
			<div class="lot__info">
				...
				<div class="lot__state">
					...
					<?php $timer = get_time_left($good['expiry_date']); ?>
					<div class="lot__timer timer <?php if ($timer['hours'] < 1) : ?>timer--finishing<?php endif; ?>">
						<?= implode(":", $timer); ?>
					</div>
				</div>
			</div>
